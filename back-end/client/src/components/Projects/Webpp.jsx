...
export default class Sort1718 extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            projects: [],
    ...
    fetchProjects() {
        ...
        .then((res) => res.json())
        .then(json => {
            var list = json.filter(p => typeof p.semester === 'string' && p.nameCourse.startsWith("Web"))
    ...
    render() {
       ...
       return (
           ...
           <div className='container-fluid' style={{ marginTop: 150, marginBottom: 50 }}>
               <div className='row justify-content-left pb-4 courses'>
